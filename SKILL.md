...
description: 角色特质抽卡与生成。从 96 正面 + 104 负面性格特质方法卡中随机抽取或查询，为角色设计提供灵感和立体化参考。当用户提到 抽卡、角色特质、性格设计、character traits、trait draw、角色人设 时触发。
user-invocable: true
argument-hint: "[特质名称 | 角色描述 | --positive N --negative N --tier major|supporting|minor --show summary|full|compact --analyze]"
